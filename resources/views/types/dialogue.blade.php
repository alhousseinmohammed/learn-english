                                        ...
                                        <div class="dialogue-content-question">
                                            <div class="dialogue-question-row">
                                                <div class="first-dialogue-row">
                                                    <div class="dialogue-row-content first-dialogue-row-content"><img
                                                            id="dialogue-character-one"
                                                            src="https://d2pur3iezf4d1j.cloudfront.net/images/85c5ecb885f7073a3aebeb775946e329">
                                                        <div class="projection-dialogue"></div>
                                                        <div class="dialogue-container first-dialogue-container"><span
                                                                class="dialogue-speaker"><button
                                                ...
                                                <div class="second-dialogue-row">
                                                    <div class="dialogue-row-content second-dialogue-row-content">
                                                        <div class="dialogue-container second-dialogue-container"><span
                                                                class="empty-dialogue"><span
                                                                    class="inner-empty-span"></span></span></div>
                                                        <div
                                        ...
                                        <div id="assist-content-options">
                                            ...
                                            <div class="outer-options-div-selected" id="outer-options-div-2">
                                                <div class="option-div-selected"><span class="option-no-selected"
                                                        id="option-no-2">2</span><span class="option-name-selected"
                                                        id="option-name-2">Oui, je prends
                                                        un dessert.</span></div>
                                            </div>
                                            @foreach (json_decode($exercise->options) as $option)
                                                ...
                                                <div class="outer-options-div" id="outer-options-div-2">
                                                    <label class="option-div" for="{{ $answerNumber }}">
                                                        <input type="radio" name="answer" id="{{ $answerNumber }}"
                                                            value={{ $option }} class="options"
                                                            style="display:none">
                                                        <span class="option-no" id="option-no-2">{{ $answerNumber }}
                                                        </span>
                                            ...
                                            @foreach (json_decode($exercise->options) as $option)
                                                ...
                                                <label class="button" for="{{ $answerNumber }}">
                                                    <l class="answer-number">{{ $answerNumber }}</l>
                        ...
                        <div class="correct-left" id="wrong-left" style="display: none">
                            <div class="correct-content">
                                ...
                                <div class="wrong-text">
                                    ...
                                    <div class="solution-text">Correct Answer</div>
                                </div>
                            </div>
                        </div>
